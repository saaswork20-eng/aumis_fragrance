...
-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('RESTOCK', 'SALE', 'ADJUSTMENT', 'RETURN');
...
-- CreateEnum
CREATE TYPE "AdPlacement" AS ENUM ('HOMEPAGE_BANNER', 'PRODUCT_GRID_INLINE', 'PROMO_MODAL');

-- CreateEnum
CREATE TYPE "AdStatus" AS ENUM ('DRAFT', 'SCHEDULED', 'ACTIVE', 'PAUSED', 'EXPIRED');
